      ...
      <div className="mb-6 flex items-center gap-2">
        ...
        {editing && toCover > 0 && (
          <button
            ...
            className="shrink-0 flex items-center gap-1.5 text-sm rounded-lg px-4 py-3 font-medium border border-stone-300 dark:border-stone-700 text-stone-600 dark:text-stone-400"
          >
            <CircleDot size={16} />
